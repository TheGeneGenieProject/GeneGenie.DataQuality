...
dotnet sonarscanner begin /k:"GeneGenie.DataQuality" /d:sonar.organization="thegenegenieproject" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.login=%SonarQubeApiKey% /d:sonar.cs.opencover.reportsPaths="%CD%\opencover.xml"
dotnet build
